...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        "fee" => "هزینه",
        "level" => "سطح",
        "meeting_no" => "تعداد جلسات",
        "pay_type" => "نوع پرداخت",
        "headings" => "سرفصل ها",
        "headings_id" => "سرفصل ها",
        "scenario" => "سناریو",
        "start_datetime" => "زمان شروع",
        "duration" => "مدت زمان",
        "description_of_meeting" => "توضیحات جلسه",
        "exercise_id" => "تمرین",
        "exercise" => "تمرین",
        "course_heading_id" => "سرفصل",
        "course_heading" => "سرفصل",
        "questions" => "سوالات",
        "file_uuid" => "فایل",
        "file" => "فایل",
        "message" => "پیام",
        ...
        "score" => "امتیاز",
        "hardship" => "سختی",
        "negative_point" => "نمره منفی",
        "overall_score" => "امتیاز",
        "published_at" => "زمان انتشار",
        "end_datetime" => "زمان پایان",
        "count" => "تعداد",
        "questions_list" => "لیست سوالات",
        "publish" => "انتشار",
        "items" => "موارد",
        "now" => "الان",
        "subject" => "موضوع",
