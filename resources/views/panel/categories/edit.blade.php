...
@section('content')
    ...
    <div class="card card-default">
        ...
        <div class="card-body">
            ...
            {!! Form::model($category, ['method' => 'PATCH','route' => ['panel.categories.update', $category->id]]) !!}
            ...
            <div class="form-group row">
                ...
                <div class="col-12 col-md-7">
                    <div class="input-group">
                        {!! Form::number('discount', $category->discount, array('class' => 'form-control', 'id' => 'discount', 'max' => 100)) !!}
